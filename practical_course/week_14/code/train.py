...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_epoch", type=int, default=12, help="number of atart epoch")
    ...
    parser.add_argument("--regu_mode", type=int, default=0, help="0:不适用正则化操作;1:使用label smooth;2:使用dropblock;3:两者均使用")
    ...
    # Initiate model
    model = Darknet(opt.model_def, regu_mode=opt.regu_mode).to(device)       # default="config/yolov3.cfg"
