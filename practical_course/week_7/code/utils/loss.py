...
class SegmentationLosses(object):
    ...
    def build_loss(self, mode='ce'):
        ...
        if mode == 'ce':  # 交叉熵损失
            ...
            return self.CrossEntropyFocalLoss
        else:
            raise NotImplementedError

    def CrossEntropyFocalLoss(self, logit, target):
        '''
        交叉熵+focal loss定义
        '''
        return self.CrossEntropyLoss(logit, target) + self.FocalLoss(logit, target, gamma=2, alpha=0.5)
