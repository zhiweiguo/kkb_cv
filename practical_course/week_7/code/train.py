...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='laneline',
                        choices=['laneline', 'pascal', 'coco', 'cityscapes'],
                        help='dataset name (default: pascal)')
    parser.add_argument('--use-sbd', action='store_true', default=True,
                        help='whether to use SBD dataset (default: True)')
    parser.add_argument('--workers', type=int, default=4,
                        metavar='N', help='dataloader threads')
    parser.add_argument('--base-size', type=str, default='513,513',
                        help='base image size')
    parser.add_argument('--crop-size', type=str, default='513,513',
    ...
    parser.add_argument('--loss-type', type=str, default='ce',
                        choices=['ce', 'dice', 'focal', 'ce_focal'],
