...
def create_modules(module_defs, active_mode=0):
    """
...
class Darknet(nn.Module):
    ...
    def __init__(self, config_path, img_size=416, regu_mode=0, active_mode=0):
        ...
        self.hyperparams, self.module_list = create_modules(self.module_defs, self.active_mode)
