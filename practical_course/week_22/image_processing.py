...
data_path = os.path.join(pwd, f'Datasets{os.sep}vggface2_test_face')
# data_path = '/data/face-datasets/vggface2_train'
face_path_mask = os.path.join(pwd, f'Datasets{os.sep}vggface2_test_face_mask')
face_path_notmask = os.path.join(pwd, f'Datasets{os.sep}vggface2_test_face_notmask')
mask_path_mask = os.path.join(pwd, f'Datasets{os.sep}vggface2_test_mask_mask')
mask_path_notmask = os.path.join(pwd, f'Datasets{os.sep}vggface2_test_mask_notmask')
