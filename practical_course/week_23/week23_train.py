...
train_dataloader = torch.utils.data.DataLoader(
    dataset=TrainDataset(
        face_dir="Datasets/vggface2_test_face_mask",
        csv_name='Datasets/vggface2_test_face_mask.csv',
        num_triplets=100000,
        training_triplets_path='Datasets/vggface2_test_face_mask_triplets.npy',
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        # 模型保存
        torch.save(model.state_dict(), 'week23_outputs_128/cbam_resnet18_{}_{:3f}.pth'.format(epoch, avg_triplet_loss))
